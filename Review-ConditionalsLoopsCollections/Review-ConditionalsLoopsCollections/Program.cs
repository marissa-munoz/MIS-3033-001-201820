...
namespace Review_ConditionalsLooopsCollections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(studentGrades[1].ToString("P2")); //get the value where the key is 1; P2 --> percent w/ two decimal places
            //Console.WriteLine(studentGrades[2].ToString("P2"));

            //if(studentGrades.ContainsKey(0) == true) //if the key is 0 then output it 
            //{
